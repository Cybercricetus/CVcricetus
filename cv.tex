...
\begin{document}
	...
	\section*{EDUCATION}
        ...
        \textbf{New York University, Tandon School of Engineering} \hfill Expected Graduation: May 2027 \\
...
\textbf{Software Engineering Intern, Data Platform \& Infrastructure} \hfill May 2026 – Aug. 2026\\
ByteDance Ltd.
\begin{itemize}
  ...
  \item Shipped user-facing Paimon data-lake APIs and a companion CLI, defining its agent-native output contract (machine-readable command schema, structured error envelopes, enumerated exit codes) as the frozen interface consumed by downstream AI-agent skills, and authored the published skill suite built on it
...
\textbf{Applied Machine Learning Software Engineering Intern} \hfill May 2025 – Aug. 2025\\
ByteDance Ltd.
\begin{itemize}
...
\textbf{Teaching Assistant, CS-UY 3224: Operating Systems} \hfill Sep. 2024 – Present\\
...
\textbf{Software Engineering Intern} \hfill Jul. 2023 – Aug. 2023\\
